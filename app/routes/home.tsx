              ...
              <div
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter" || e.key === " ") {
                    ...
                    e.currentTarget.classList.toggle("ring-[var(--color-accent)]");
                  }
                }}
                className="bg-[var(--color-surface)] border border-[var(--color-primary-dark)] rounded-xl p-8 hover:border-[var(--color-primary)] transition-all duration-300 hover:shadow-lg hover:shadow-[var(--color-primary)]/10 opacity-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)]"
              >
